...
-- ANSWER_HERE
CREATE NONCLUSTERED INDEX FK_OrderDetails_OrderNumber
ON OrderDetails(OrderNumber)

CREATE NONCLUSTERED INDEX Fk_OrderDetails_ProductNumber
...
-- ANSWER_HERE
SELECT DriverFirstName + DriverLastName AS 'DriverFullName', VehicleNumber, DeliveryNumber
FROM Vehicles
WHERE MONTH([date]) = 9
GO
...
SELECT P.ProductNumber, P.Description, P.CurrentPrice, O.OrderNumber, Quantity, SellingPrice
FROM Products AS P
GO
