...
GO
SELECT OrderNumber,Customernumber,OrderDate,GSTAmount,PaidYN
FROM Orders
...
-- ANSWER_HERE
SELECT ProductNumber, Quantity,SellingPrice
from OrderDetails 
...
-- ANSWER_HERE
SELECT DriverFirstname + ''+ DriverLastName as fullname , VehicleNumber, DeliveryNumber
from Vehicles 
